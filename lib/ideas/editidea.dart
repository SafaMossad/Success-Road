...
//mangment controlling
  ...
  @override
  void initState() {
    _ideaTitleController = new TextEditingController(text: widget.list[widget.index]['title']);
    _ideaCategoryController = new TextEditingController(text: widget.list[widget.index]['ideacatagory']);
    _fundingController = new TextEditingController(text: widget.list[widget.index]['funding']);
    _managementTypeController = new TextEditingController(text: widget.list[widget.index]['Management']);
    _addressController = new TextEditingController(text: widget.list[widget.index]['address']);
    _ideaDescriptionController = new TextEditingController(text: widget.list[widget.index]['ideaDescription']);
  }
